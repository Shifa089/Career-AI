...
import com.careerai.interview.security.HeaderAuthenticationFilter;
...
/**
 * Stateless security for interview-service. The API gateway validates JWTs and forwards identity
 * headers for REST calls; the {@link HeaderAuthenticationFilter} turns those headers into an
 * authentication. The WebSocket handshake ({@code /ws/**}) is authenticated separately by the STOMP
 * channel interceptor, so it is permitted here.
 */
@Configuration
@EnableWebSecurity
