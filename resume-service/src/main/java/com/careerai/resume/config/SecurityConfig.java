...
import com.careerai.resume.security.HeaderAuthenticationFilter;
...
/**
 * Stateless security for resume-service. The API gateway validates JWTs and forwards identity
 * headers; the {@link HeaderAuthenticationFilter} turns those headers into an authentication.
 * Unauthenticated/forbidden requests are rendered as JSON {@link ApiResponse} errors.
 */
@Configuration
@EnableWebSecurity
